...
location_table: Dict[str, ACTLocationData] = {
    ...
    lname.hairclaw_scuttleport_rooftopedge: ACTLocationData(rname.scuttleport, 449, "Scuttleport"), #7b5d1b34-3a32-45a5-9c39-77f389e19658-2_C-Facilities
    lname.hairclaw_scuttleport_rooftoptrash: ACTLocationData(rname.scuttleport, 450, "Scuttleport"), #3491a71f-e680-4455-b86c-16c4b46fd9e4-2_C-Facilities
    lname.hairclaw_scuttleport_survivorcamp: ACTLocationData(rname.scuttleport, 452, "Scuttleport"), #5ef755f7-50bb-423c-92b2-03455f92fd13-2_C-Facilities
    lname.clothesclaw_scuttleport_npccrab: ACTLocationData(rname.scuttleport, 454, "Scuttleport"), #f94ca676-2e0f-4ca1-acbf-06c327b51480-2_C-Facilities
    lname.chipclaw_scuttleport_survivorcamp: ACTLocationData(rname.scuttleport, 457, "Scuttleport"), #acec02a3-4585-4671-bab2-787caa9cf456-2_C-Facilities
    lname.clothesclaw_scuttleport_magrail1: ACTLocationData(rname.scuttleport, 461, "Scuttleport"), #12ff423d-092a-4b8f-a25e-c25ba1b6c1b1-2_C-Facilities
    lname.clothesclaw_scuttleport_magrail2: ACTLocationData(rname.scuttleport, 462, "Scuttleport"), #f6a613bf-a9e8-4561-86e6-7cb491a5796e-2_C-Facilities
    lname.hairclaw_scuttleport_magrailroof1: ACTLocationData(rname.scuttleport, 463, "Scuttleport"), #fdf786b1-912d-4d21-94a2-4b537df8a3a8-2_C-Facilities
    lname.paperclaw_scuttleport_magrail: ACTLocationData(rname.scuttleport, 466, "Scuttleport"), #35fbece2-5d6b-40c1-b971-ede62272a563-2_C-Facilities
    lname.hairclaw_scuttleport_magrailroof2: ACTLocationData(rname.scuttleport, 467, "Scuttleport"), #7b3d0a88-815a-453b-95bb-ba41d5c06e46-2_C-Facilities
    lname.chipclaw_scuttleport_magrail: ACTLocationData(rname.scuttleport, 468, "Scuttleport"), #f8892e4f-5b3e-4d02-9408-d061c129361e-2_C-Facilities
    lname.hairclaw_scuttleport_magrail: ACTLocationData(rname.scuttleport, 472, "Scuttleport"), #13b3ad68-84d2-408e-89ee-925827c3fca5-2_C-Facilities
    lname.chipclaw_scuttleport_propanebridge: ACTLocationData(rname.scuttleport, 473, "Scuttleport"), #173d1895-0c4d-479c-9c1f-0b4e28ce8c76-2_C-Facilities
    lname.clothesclaw_scuttleport_propanebridge: ACTLocationData(rname.scuttleport, 475, "Scuttleport"), #07d78994-2181-4def-b0ee-6a2c5a018757-2_C-Facilities
    ...
    lname.stainlessrelic_scuttleport_clam: ACTLocationData(rname.scuttleport, 438, "Scuttleport"), #5b38d7db-b409-4b96-98aa-e1a861365453-2_C-Facilities
    lname.bloodstar_scuttleport_magrailclam: ACTLocationData(rname.scuttleport, 469, "Scuttleport"), #fc60178b-0659-4d17-8360-4e51d468355e-2_C-Facilities
    lname.stainlessrelic_scuttleport_magrail: ACTLocationData(rname.scuttleport, 470, "Scuttleport"), #7a52c7e5-0f02-4274-90b6-3bcc0b183d61-2_C-Facilities
    lname.stainlessrelic_scuttleport_propanebridge: ACTLocationData(rname.scuttleport, 481, "Scuttleport"), #77ad1389-a337-45d7-a5e5-d6aa57f6295d-2_C-Facilities
    lname.oldworldwhorl_scuttleport_eelectrocute: ACTLocationData(rname.scuttleport, 483, "Scuttleport"), #cb9dc74c-99b9-4a54-81b4-eb9997551ad2-2_C-Facilities
    ...
    lname.barbedhook_scuttleport_sorting: ACTLocationData(rname.scuttleport, 439, "Scuttleport"), #944f517e-6c6b-40f2-88ec-a5490dd08ab0-2_C-Facilities
    lname.barbedhook_scuttleport_magnetdropoff1: ACTLocationData(rname.scuttleport, 442, "Scuttleport"), #cb37f39c-6d87-4151-bbc0-11029c60ebbc-2_C-Facilities
    ...
    lname.barbedhook_scuttleport_magnetdropoff2: ACTLocationData(rname.scuttleport, 448, "Scuttleport"), #e2b1726c-2622-4dbc-930b-72e296ec9ceb-2_C-Facilities
    lname.barbedhook_scuttleport_trashblock: ACTLocationData(rname.scuttleport, 453, "Scuttleport"), #75fef681-50e5-4e53-a61e-d2014e9e44f2-2_C-Facilities
    lname.barbedhook_scuttleport_magrail1: ACTLocationData(rname.scuttleport, 459, "Scuttleport"), #b757dc2e-1d8b-4263-9718-93d78d86d98b-2_C-Facilities
    lname.barbedhook_scuttleport_magrail2: ACTLocationData(rname.scuttleport, 460, "Scuttleport"), #7ab018f0-a203-4746-8ef0-4452cc6b8cd0-2_C-Facilities
    lname.barbedhook_scuttleport_magrailroof: ACTLocationData(rname.scuttleport, 465, "Scuttleport"), #3ae12d7f-a589-4f70-8d1b-2d445ad8f34e-2_C-Facilities
    lname.barbedhook_scuttleport_magrail3: ACTLocationData(rname.scuttleport, 471, "Scuttleport"), #264db2a2-8767-40b3-a9e9-1b87669e7fc0-2_C-Facilities
    lname.barbedhook_scuttleport_propanebridge: ACTLocationData(rname.scuttleport, 474, "Scuttleport"), #ad1f2eed-11dc-4980-be85-139863b3f4e8-2_C-Facilities
    lname.barbedhook_scuttleport_afterbridge: ACTLocationData(rname.scuttleport, 476, "Scuttleport"), #085e9638-f3e8-4fee-b725-7879ecbc8b04-2_C-Facilities
    lname.barbedhook_scuttleport_propaneroof1: ACTLocationData(rname.scuttleport, 477, "Scuttleport"), #d18b2837-c335-4535-9ce7-e7b9b44af347-2_C-Facilities
    lname.barbedhook_scuttleport_propaneroof2: ACTLocationData(rname.scuttleport, 478, "Scuttleport"), #095af59b-ebcd-4dc6-87fc-71239d3e2c98-2_C-Facilities
    ...
    lname.limpet_scuttleport_electricboxes: ACTLocationData(rname.scuttleport, 437, "Scuttleport"), #416129a7-73dc-49db-884e-dd39081c159f-2_C-Facilities
    lname.rubberband_scuttleport_magnetdropoff: ACTLocationData(rname.scuttleport, 440, "Scuttleport"), #37f09b48-7c2f-447e-9c87-5c29f6d0685f-2_C-Facilities
    lname.limpet_scuttleport_magnet: ACTLocationData(rname.scuttleport, 441, "Scuttleport"), #09cdcb1f-cb62-4a7c-a9a1-04aba76325c4-2_C-Facilities
    lname.anemoneplus_scuttleport_magnetdropoff: ACTLocationData(rname.scuttleport, 443, "Scuttleport"), #89d87d3d-1e06-4fd4-8def-17aff3474b11-2_C-Facilities
    ...
    lname.sinkerplusplus_scuttleport_clam: ACTLocationData(rname.scuttleport, 451, "Scuttleport"), #4f0723b9-506c-4bcd-a86a-817c5394c800-2_C-Facilities
    lname.seastar_scuttleport_survivorcamp: ACTLocationData(rname.scuttleport, 455, "Scuttleport"), #a503e8bd-3fb8-4b51-840b-927469510cdf-2_C-Facilities
    lname.pufferquill_scuttleport_survivorcamp: ACTLocationData(rname.scuttleport, 456, "Scuttleport"), #060c2ec3-888a-42ad-afd2-e33f45c409a9-2_C-Facilities
    lname.turtleshell_scuttleport_survivorcamp: ACTLocationData(rname.scuttleport, 458, "Scuttleport"), #dc30d0d1-3ea2-4b93-9871-2169630e22ef-2_C-Facilities
    lname.rustynailplus_scuttleport_magrail: ACTLocationData(rname.scuttleport, 464, "Scuttleport"), #f8e6d62e-3276-4643-a0f4-f403be5c6fbb-2_C-Facilities
    lname.barnacleplus_scuttleport_propanebridge: ACTLocationData(rname.scuttleport, 479, "Scuttleport"), #30faa811-16e1-433a-977c-d18e5352e0f9-2_C-Facilities
    lname.salp_scuttleport_propanebridge: ACTLocationData(rname.scuttleport, 480, "Scuttleport"), #7fe50500-c6e8-4846-a313-b44f426fb6a3-2_C-Facilities
    lname.musselplus_scuttleport_voltai: ACTLocationData(rname.scuttleport, 482, "Scuttleport"), #5d4e293b-0bc2-489d-8965-f7caba1c762c-2_C-Facilities
