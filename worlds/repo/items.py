...
item_table: Dict[str, REPOItemData] = {
    ...
    iname.progressive_health: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,3,(base_shop_offset:=base_shop_offset+1),"Shop Unlock"),
    iname.baseball_bat: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Melee Shop Unlock"),
    iname.frying_pan: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Melee Shop Unlock"),
    iname.sledge_hammer: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Melee Shop Unlock"),
    iname.sword: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Melee Shop Unlock"),
    iname.inflatable_hammer: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Melee Shop Unlock"),
    iname.prodzap: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.gun: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Ranged Shop Unlock"),
    iname.shotgun: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Ranged Shop Unlock"),
    iname.tranq_gun: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.pulse_pistol: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.photon_blaster: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Ranged Shop Unlock"),
    iname.boltzap: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.cart_cannon: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Ranged Shop Unlock"),
    iname.cart_laser: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Ranged Shop Unlock"),
    iname.grenade: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Explosive Shop Unlock"),
    iname.shock_grenade: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.human_grenade: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Explosive Shop Unlock"),
    iname.stun_grenade: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.duct_taped_grenade: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Explosive Shop Unlock"),
    iname.shockwave_mine: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.stun_mine: REPOItemData(ItemClassification.progression_deprioritized_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Stun Shop Unlock"),
    iname.explosive_mine: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Explosive Shop Unlock"),
    iname.rubber_duck: REPOItemData(ItemClassification.useful,1,(base_shop_offset:=base_shop_offset+1),"Shop Unlock"),
    iname.recharge_drone: REPOItemData(ItemClassification.useful,1,(base_shop_offset:=base_shop_offset+1),"Drone Shop Unlock"),
    ...
    iname.feather_drone: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Drone Shop Unlock"),
    iname.zero_grav_drone: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Drone Shop Unlock"),
    ...
    iname.energy_crystal: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Shop Unlock"),
    iname.zero_grav_orb: REPOItemData(ItemClassification.progression_skip_balancing,1,(base_shop_offset:=base_shop_offset+1),"Shop Unlock"),
