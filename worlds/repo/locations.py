...
location_table: Dict[str, REPOLocationData] = { 
    ...
    lname.ring:	                REPOLocationData(rname.headman,(v:=v+1),"Light Valuable"),
    ...
    lname.frog_toy:	            REPOLocationData(rname.headman,(v:=v+1),"Light Valuable"),
    lname.monkey:	            REPOLocationData(rname.headman,(v:=v+1),"Medium Valuable"),
    ...
    lname.camera_old:	        REPOLocationData(rname.headman,(v:=v+1),"Medium++ Valuable"),
    ...
    lname.champagne:	        REPOLocationData(rname.headman,(v:=v+1),"Medium Valuable"),
    ...
    lname.large_vase:	        REPOLocationData(rname.headman,(v:=v+1),"Heavy Valuable"),
    lname.grand_piano:	        REPOLocationData(rname.headman,(v:=v+1),"Very Heavy Valuable"),
    ...
    lname.petri_dish:	        REPOLocationData(rname.mcjannek,(v:=v+1),"Light Valuable"),
    ...
    lname.extinguisher:	        REPOLocationData(rname.mcjannek,(v:=v+1),"Medium+ Valuable"),
    ...
    lname.griffin:	            REPOLocationData(rname.swiftbroom,(v:=v+1),"Very Heavy Valuable"),
    lname.dragon_statue:	    REPOLocationData(rname.swiftbroom,(v:=v+1),"Heavy++ Valuable"),
